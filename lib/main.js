...
function createThemeData(color, font) {
	let result = "@seti-primary: @" + color.toLowerCase() + ";";
	result += "@seti-primary-text: @" + color.toLowerCase() + "-text;";
	result += "@seti-primary-highlight: @" + color.toLowerCase() + "-highlight;";
	result += "@seti-font-family: " + font + ";";
